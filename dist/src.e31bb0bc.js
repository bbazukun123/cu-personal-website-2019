...
function () {
  function Router(routes) {
    ...
    this.routes = routes;
    this.rootElem = document.getElementById("app"); //init();
  ...
  _createClass(Router, [{
    ...
    key: "hasChanged",
    value: function hasChanged(scope, r) {
      if (window.location.hash.length > 0) {
        ...
        for (var _i = 0, _length = r.length; _i < _length; _i++) {
          var _route = r[_i];
          if (_route.defaultRoute) scope.goToRoute(_route.htmlName);
        }
      }
    }
  }, {
...
},{"./js/router":"js/router.js","./js/route":"js/route.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
